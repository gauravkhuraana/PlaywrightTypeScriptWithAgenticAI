...
test.describe('Example Page Tests with Page Object', () => {
  ...
  test('should interact with more info link using page object @smoke', async ({ examplePage }) => {
    // Navigate to page
    await examplePage.goto();
    await examplePage.waitForPageLoad();
  ...
  test('should validate page structure using page object @smoke', async ({ examplePage }) => {
  ...
  test('should demonstrate page object logging capabilities @smoke', async ({ examplePage }) => {
