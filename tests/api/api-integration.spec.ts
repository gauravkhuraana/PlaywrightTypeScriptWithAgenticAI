...
test.describe('API Integration Tests', () => {
  ...
  test('should test GET request with httpbin @api @smoke', async ({ apiClient, logger }) => {
  ...
  test('should test JSON data with httpbin @api @smoke', async ({ apiClient, logger }) => {
  ...
  test('should test POST request with httpbin @api @crud', async ({ apiClient, logger }) => {
  ...
  test('should test PUT request with httpbin @api @crud', async ({ apiClient, logger }) => {
  ...
  test('should test DELETE request with httpbin @api @crud', async ({ apiClient, logger }) => {
  ...
  test('should handle API error responses @api @error-handling', async ({ apiClient, logger }) => {
  ...
  test('should validate API response schema @api @schema', async ({ apiClient, logger }) => {
